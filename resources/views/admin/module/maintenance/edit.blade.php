    ...
    <div class="table-agile-info">
        <div class="panel panel-default">
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <fieldset>
                    <legend>Chính sách bảo hành</legend>
                    <span class="form_label">Nội dung:</span>
                    <span class="form_item">
			<textarea name="txtFull" rows="200" class="textbox">
			{!! old('txtFull',isset($maintenance["content"]) ? $maintenance["content"] : null) !!}
			</textarea>
			<script type="text/javascript">
				var editor = CKEDITOR.replace('txtFull', {
                    ...
                    @if(Auth::user()->role==1)
                        ...
                        <span class="form_item">
			<input type="submit" name="btnNewsEdit" value="Cập nhật Chính sách bảo hành" class="btn btn-success pull-right"/>
		</span>
                    @endif
                </fieldset>
            </form>
