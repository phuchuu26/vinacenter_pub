                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input name="phone_customer" class="form-control" type="text" value="{{$customer->phone ?? ''}}">
{{--                                    <select id="phone_customer" name="phone_customer"  class="form-control">
                            ...
                            <div class="col-lg-4">
                                <div class="input-group mb-3">
                                    ...
                                    <input required type="text" name="name_customer" value="{!! $customer->fullname ?? '' !!}"
                                    class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="input-group mb-6">
                                    ...
                                    <input type="text" name="product_name" class="form-control" value="{!! $orderDetail->product_name ?? ''  !!} " />
        ...
        <div class="row">
            ...
            @endif
             --}}
            <div  class="col-lg-6">
                <button  style="float: right!important;"  type="submit" name="btnNewsAdd"  class="btn btn-success" >Tạo yêu cầu Bảo hành</button> 
