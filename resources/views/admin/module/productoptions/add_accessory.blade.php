...
<head>
    ...
    <div class="table-agile-info">
        ...
        <div class="panel panel-default">
            <table class="table">
                <tbody>
                    ...
                    <form action="{{ route('postAddAccessoryDetail', ['id' =>  $productoption->id ])}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <a href="{{ route("getProductOptionEdit", ['id' => $productoption->id, 'pro_id' => $product->id])}} "
                      class="btn btn-secondary" >Quay lại</a>
                
            </div>
            
            <div  class="col-lg-6">
                <button style="float: right!important;" type="submit" name="btnNewsAdd"  class="btn btn-success" >Thêm Option Phụ kiện</button>
