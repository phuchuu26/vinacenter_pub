...
<head>
    ...
    <div class="table-agile-info">
                                    ...
                                    @foreach ($data->serviceCustomerDetail as $dataDetail)
                                        ...
                                        <tr >
                                            ...
                                            <th style="   width: 8%;   font-weight: normal;">
                                                ...
                                                <a  href="{{ route('getServiceCustomerDetailDelete' , ['id_data_detail' => $dataDetail->id_service_customer_detail])}}" style="font-size:10px!important;"  type="button" class="btn btn-danger">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <a href="{{ route("getListServiceCustomer")}} "  class="btn btn-secondary" >Quay lại</a>
                
            </div>


            <div  class="col-lg-6">
                <button  style="float: right!important;"  type="submit" name="btnNewsAdd"  class="btn btn-success" >Cập nhật Dịch vụ khách hàng</button> 
