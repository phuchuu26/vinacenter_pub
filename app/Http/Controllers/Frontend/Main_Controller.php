...
class MainController extends Controller
{
    public function getIndex(){
        ...
        $productSaleTop = ProductOption::where('salestop_salesoff',2)->limit(8)->orderBy('id','DESC')->get()->toArray();
    	$productSale = ProductOption::where('salestop_salesoff',3)->limit(8)->orderBy('id','DESC')->get()->toArray();
    	
        $productRan = ProductOption::orderBy('created_at', 'desc')->take(8)->get()->toArray();
